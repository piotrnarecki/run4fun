  ...
  Widget build(BuildContext context) {
    switch (loginState) {
      ...
      case ApplicationLoginState.emailAddress:
        return EmailForm(
            callback: (email) => verifyEmail(
                email, (e) => _showErrorDialog(context, 'Nieprawidłowy email', e)));
      ...
      default:
        return Row(
          children: [
            Text("Błąd wewnętrzny, coś poszło nie tak..."),
          ],
        );
    }
  }
...
class _EmailFormState extends State<EmailForm> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Header('Zaloguj się przy użyciu swojego adresu email'),
        Padding(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'Wprowadź swój adres email, aby kontynuować';
                      }
                      return null;
                    },
                  ),
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'Wprowadź swoją nazwę konta';
                      }
                      return null;
                    },
                  ),
